...
/**
   Set initial conditions for the MacCormic 2nd order algorithm. The
   user defined qinit function is called to compute value of conserved
...
*/
void
maccor2_initialize(Run_Data& rd, FArray<double>& q)
{
